...
> **状态：建设中（公开开发）。** P0（可行性验证）与 P1（模型网关 + 按人计量）已完成，并对真实 API 做了端到端验证。下一步 P2（账号、登录、门户）。完整路线图与任务清单见 [`docs/PLAN.md`](docs/PLAN.md)，验证记录见 [`docs/BASELINE.md`](docs/BASELINE.md)，每日进展见 [`docs/devlog/`](docs/devlog/)。
